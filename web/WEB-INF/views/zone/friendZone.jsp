    ...
    <div class="w1100 jz">
        ...
        <div class="fr">
            <div class="dynamic_title">
                <ul>
                    <li class="dynamic_i inlineblock"><a href="<%=path%>/zone/myZone">动态广场</a><i class="triangle"></i></li>
                    <li class="dynamic_i on inlineblock"><a href="<%=path%>/zone/friendZone">朋友圈</a><i class="triangle"></i></li>
                    <li class="dynamic_i inlineblock"><a href="<%=path%>/zone/recommendZone">推荐动态</a><i class="triangle"></i></li>
                </ul>
            </div>
            <div class="dynamic_main">
                ...
                <a class="no-zone-msg hide" href="<%=path%>/index/iHome">您还没有朋友圈的动态，快去认识一些朋友吧！</a>
            </div>
        </div>
        <div class="clear"></div>
    </div>
