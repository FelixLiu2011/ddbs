                ...
                <div class="PersonalHomepage-top">
                    ...
                    <div class="PersonalHomepage-top-r fl pt5 ml10">
                        ...
                        <p class="ari f16 c-2d57a1"><span class="nic" id="nic">Quintion</span>
                            ...
                            <a href="http://www.gagahi.com:80/Member/memberinformation?type=1"><span class="edit" id="edit" data-explain="编辑资料" ></span></a></p>
                        <p>
							<span>
							男
                ...
                <div class="photo-all ">
                    <div class="photo-all-top">
                        ...
                        <div class=" fr">
                            ...
                            <a  class="h30 tc w100 bgc-2d57a1 c-fff bdra15 ml10" href="http://www.gagahi.com:80/pay/upgradeMember">升级会员</a>
                        </div>
                        <div class=" clear"></div>
                    </div>
            ...
            if(parseInt(allownum)>parseInt(memberPhotoNum)){
                if(memberPhotoNum==12){
                    ...
                    layer.open({
                        ...
                        yes: function(index, layero) {
                            layer.close(index);
                            window.location.href="http://www.gagahi.com:80/pay/upgradeMember";
                        },
                        cancel: function(index) {},
                    });
                }
