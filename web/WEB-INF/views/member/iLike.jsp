...
<div class="mid">
    <div class="w1100 jz">
        ...
        <div class="fr smallcount">
            <div class="rht">
                <div class="shengji">
                    <img src="<%=path%>/common/images/xiehou.jpg" class=" mt100 mb45">
                    <p style="font-size:22px;" class="mb20">还没有您喜欢的人？</p>
                    <p class="f16" style="margin-bottom:50px;">浏览喜欢我的人，找到彼此都心动的人</p>
                    <p><button class="bdra30 h36 f18 bgc-2d57a1 c-fff gotoencounterhome">去邂逅</button></p>
                </div>
            </div>
        </div>
...
<script>
     ...
     * 挑战至偶遇
     */
    $(document).on("click",".gotoencounterhome",function(){
        window.location.href="http://www.gagahi.com:80/ihome/index";
    });
...
//$(".Cancel-like").click(function(e) {
        layer.open({
            offset: '430px',
            area: ['220px',''],
            skin: 'Cancel-like-pop',
            type: 1,
            title: false,
            content: '<p class="tc">确认取消吗？</p>',
            btn: ['确认', '取消'],
            yes: function (index, layero) {
                //console.log(index+'||'+layero)
                layer.close(index);
...
//$(".gift").click(function(e) {
            ...
            success: function(data){
                if(data.success){
                    ...
                    if(null == lis || lis <= 0){//没有喜欢的人
                        ...
                        var str = "<div class=\"fr smallcount\">"
                                +"<div class=\"rht\">"
                                +"<div class=\"shengji\">"
                                +"<img src=\"<%=path%>/common/images/xiehou.jpg\" class=\" mt100 mb45\">"
                                +"<p style=\"font-size:22px;\" class=\"mb20\">还没有您喜欢的人？</p>"
                                +"<p class=\"f16\" style=\"margin-bottom:50px;\">浏览喜欢我的人，找到彼此都心动的人</p>"
                                +"<p><button class=\"bdra30 h36 f18 bgc-2d57a1 c-fff gotoencounterhome\">"
                                +"去邂逅</button></p>"
                                +"</div></div></div>";
     ...
     * count		私信条数
     */
    function allletter(mefiLevel,mefiGold,count){
        layer.open({
            area: '542px',
            skin: 'privateall',
            title:'提示',
            ...
            yes: function (index, layero) {
                ...
                var msg = $(".xld.inlineblock").text();
                $.ajax({
                    type : "post",
                    url : "http://www.gagahi.com:80/Member/Like/allletter",
                    contentType : "application/x-www-form-urlencoded",
                    data: {"msg":msg},
                    success: function(data){
                        if(data.success){
        ...
        var str ="";
        if(mefiLevel != 2 && mefiLevel != 3){//普通会员
            if(mefiGold < count){
                str = "<br><a herf='' class='lj'><span class='c-2d57a1'>升级会员</span>更划算</a><a class='Disable'>发送</a>";
            }
        }
        $(".layui-layer-btn0").after(str);
    }
...
<div class="privateallCon" style="display: none;">
    <div class="balance tc">
        ...
        <span class="hui ml10">（您金币余额为 0.00 金币）</span>
    </div>
    <div class="lxlb h36 bdra30" style="margin: 50px auto 45px;">
        <span class="xld inlineblock">你喜欢什么类型的异性？</span>
