    ...
    <div class="w1100 jz">
        ...
        <div class="fr">
            <div class="dynamic_title">
                <ul>
                    <li class="dynamic_i on inlineblock"><a href="http://www.gagahi.com:80/Zone/">Feeds Square</a><i class="triangle"></i></li>
                    <li class="dynamic_i inlineblock"><a href="http://www.gagahi.com:80/Zone/friend/">Friends</a><i class="triangle"></i></li>
                    <li class="dynamic_i inlineblock"><a href="http://www.gagahi.com:80/Zone/recomm/">Recommendation</a><i class="triangle"></i></li>
                </ul>
            </div>
            <div class="dynamic_main">
                ...
                <a class="no-zone-msg hide" href="http://www.gagahi.com:80/ihome/">You do not have a circle of friends of the dynamic, quick to know some friends!</a>
            </div>
        </div>
        <div class="clear"></div>
    </div>
