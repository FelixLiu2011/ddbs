...
<head>
    ...
    <link href="common/js/ScrollBar/jquery.mCustomScrollbar.css" rel="stylesheet" type="text/css">
    <link href="common/css/base.css" rel="stylesheet" type="text/css">
    <link href="common/css/common.css" rel="stylesheet" type="text/css">
    <link href="common/css/webupload.css" rel="stylesheet" type="text/css">
    <link href="common/css/jquery.range.css" rel="stylesheet" type="text/css">
    <link href="common/css/jquery.range.css" rel="stylesheet" type="text/css">
    <link href="common/css/lang.css" rel="stylesheet" type="text/css">
    ...
    <script  src="common/js/laytpl.js"       type="text/javascript"></script>
    <script  src="common/js/core.js"    type="text/javascript"></script>
    <script  src="common/js/i18next-1.11.2.min.js" type="text/javascript"></script>
    <script type="text/javascript">
    ...
    <script src="common/js/webuploader.js" type="text/javascript"></script>
    <script src="common/layer/js/layer.js" type="text/javascript"></script>
    <script src="common/js/template.js" type="text/javascript"></script>
    <script src="common/js/global_plugin.js" type="text/javascript"></script>
    <script src="common/js/ScrollBar/jquery.mCustomScrollbar.concat.min.js" type="text/javascript"></script>
    <script src="common/js/jquery.cookie.js" type="text/javascript"></script>
    <script src="common/js/koala.min.1.5.js" type="text/javascript"></script>
    <script src="common/js/terminator2.2.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="common/IM/js/processingTime.js"></script>
    <script type="text/javascript" src="common/js/gift.js"></script>
    <script type="text/javascript">
        $(function(){
        ...
        <div id="fsD1" class="focus">
            <div id="D1pic1" class="fPic">
                <div class="fcon" style="display: none;">
                    <a><img src="common/images/zh-cn-xb01.jpg" style="opacity: 1; "></a>
                    <span class="shadow" data-i18n="sm1.tu1"></span>
                </div>

                <div class="fcon" style="display: none;">
                    <a><img src="common/images/zh-cn-xb02.jpg" style="opacity: 1; "></a>
                    <span class="shadow" data-i18n="sm1.tu2"></span>
                </div>

                <div class="fcon" style="display: none;">
                    <a><img src="common/images/zh-cn-xb03.jpg" style="opacity: 1; "></a>
                    <span class="shadow" data-i18n="sm1.tu3"></span>
                </div>

                <div class="fcon" style="display: none;">
                    <a><img src="common/images/zh-cn-xb04.jpg" style="opacity: 1; "></a>
...
<div class="head"  gagaid="2935498">
    <div class="w1100 jz">
        <div class="fl">
            <a href="http://www.gagahi.com:80/ihome" class="logo"><img src="common/images/logo.png" alt="gagahi"/></a>
            ...
            <div class="xl xlfrd">
                ...
                <div class="nr">
                    <ul class="yhy yts1 mCustomScrollbar _mCS_1 mCS_no_scrollbar ihome_top_apply_friend_ul" >
                        <!-- <h3>加好友申请</h3> -->
                        <!-- <li><span class="tx"><img src="common/images/gg1.jpg"></span><span class="nm">Nita2009</span>
                          <p class="fr">
                            <button>同意</button>
                            <button>忽略</button>
                          </p>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        Qfast.add('widgets', { path: "common/js/terminator2.2.min.js", type: "js", requires: ['fx'] });
...
<link type="text/css" href="common/IM/css/im.css" rel="stylesheet" />
<link type="text/css" href="common/IM/css/qqFace.css"
      rel="stylesheet" />
<link type="text/css" href="common/IM/css/webuploader.css"
      rel="stylesheet" />
<script type="text/javascript">
...
<div id="IM">
        ...
        <div id="js-hiddenScrollBar" class="hiddenScrollContainer">
            <ul class="hiddenContactsCon">
                <li class="content singleNum" data-signid="people" data-gagaid="-1" data-remarkname="嘎嘎客服" data-nickname="嘎嘎客服" data-shield="0" data-online="2" data-language="zh">
                    <div class="headDiv">
                        <img class="headImg" src="common/images/gagaService.png">
                        <img class="headLine" src="common/IM/img/On-line.png" style="display:none">
                    </div>
                </li>
            </ul>
    ...
    <div id="IMgagaService">
        <img src="common/IM/img/gagaService.png">
...
<script type="text/javascript" src="common/IM/js/ImUploadIMG.js"></script>
<script type="text/javascript" src="common/IM/js/jquery.qqFace.js"></script>
<script type="text/javascript" src="common/IM/js/IMAjax.js"></script>
<script type="text/javascript" src="common/IM/js/chatBox.js"></script>




<link href="common/css/zfx.css" rel="stylesheet" type="text/css">
<link href="common/css/webupload.css" rel="stylesheet" type="text/css">
<link href="common/css/zone.css" rel="stylesheet" type="text/css">
<div class="mid">
    <div class="w1100 jz">
        ...
        <div class="fr">
            <div class="dynamic_title">
                <ul>
                    <li class="dynamic_i inlineblock"><a href="http://www.gagahi.com:80/Zone/">动态广场</a><i class="triangle"></i></li>
                    <li class="dynamic_i on inlineblock"><a href="http://www.gagahi.com:80/Zone/friend/">朋友圈</a><i class="triangle"></i></li>
                    <li class="dynamic_i inlineblock"><a href="http://www.gagahi.com:80/Zone/recomm/">推荐动态</a><i class="triangle"></i></li>
                </ul>
            </div>
            <div class="dynamic_main">
                ...
                <a class="no-zone-msg hide" href="http://www.gagahi.com:80/ihome/">您还没有朋友圈的动态，快去认识一些朋友吧！</a>
            </div>
        </div>
        <div class="clear"></div>
    </div>
...
<script src="common/js/global_plugin.js"></script>
<script src="common/js/platformCountryElementMap.js"></script>
<script src="common/js/zonelist.js" type="text/javascript"></script>
<script>
    var curLanguage = Zoneyet.Global.language || 'zh-cn';
    var initZoneObj = new initZoneList();
    var pageMethod = 'friend';
    $(function() {
        initZoneObj.getData(undefined, undefined, pageMethod);
...
<!--登录弹出框开始-->
<link href="common/css/login-layer.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="common/js/laytpl.js"  ></script>
<script type="text/javascript">
    $(function(){
            ...
            onRead:function(msg){
                if(msg.type==9){//系统消息
                    ...
                    if(message.type==1){
                        ...
                        var html = "<li class='f13'><span class='tx'><img src='common/images/gg1.jpg'></span>";
                        ...
                        if(null != message.content && null != message.content.mfstRelevel){
                            ...
                            if(message.content.mfstRelevel == "2"){//高级
                                $(".lfttop").find(".ari:first").append("<img src=\"common/images/hg.jpg\">");
                            }else if(message.content.mfstRelevel == "3"){//vip
                                $(".lfttop").find(".ari:first").append("<img src=\"common/images/vip-hg.jpg\">");
                            }
