    ...
    <div class="w1100 jz">
        ...
        <div class="fr w860">
            ...
            <div class="content1 mt15">
                <div class="vip-cont" style="min-height: 400px; ">
                    <dl class="w760 mb20">
                        <dt class="fb mb10">1、什么是网站金币？</dt>
                        <dd class="vip-help-words">本网站为用户提供金币服务，你可以在本网站购买和使用金币。金币没有期限限制。金币不可退还。金币没有货币 价值，不得站外私自买卖或转让。</dd>
                    </dl>
                    <dl class="w760 mb20">
                        <dt class="fb mb10">2、如何充值/购买金币？</dt>
                        <dd class="vip-help-words">您可以登录-充值。我们目前仅提供PayPal、支付宝等网络安全支付方式，如果您没有PayPal账户，您可以选择 -PayPal-信用卡支付的方式。所有的支付方式都是绝对安全的。本站绝没有任何自动记忆或重复收费的程序。有任 何疑问，请马上与我们联系。</dd>
                    </dl>
                    <dl class="w760 mb20">
                        <dt class="fb mb10 ">3、一金币需要多少美元？</dt>
                        <dd class="vip-help-words">1枚金币大约需要1美元。</dd>
                    </dl>
                    <dl class="w760 mb20">
                        <dt class="fb mb10">4、充值有优惠吗？</dt>
                        <dd class="vip-help-words">充值1金币需1美元，目前充值没有优惠。</dd>
                    </dl>
                    <dl class="w600 mb20">
                        <dt class="fb mb10">5、在充值页面无法成功充值？</dt>
                        <dd class="vip-help-words">请尝试以下解决方案：<br /> （1）请先查看你的信用卡是否有问题。
                            <br /> （2）更换浏览器重新尝试一下。
                            <br /> （3）如在系统提示您的信用卡不能用于支付这笔交易，请联系贝宝。
                            <br /> 如果所有方法都尝试过后仍旧无法成功充值，请联系我们。
                        </dd>
                    </dl>
                    <dl class="w600 mb20">
                        <dt class="fb mb10">6、充值过后多长时间可以到账？</dt>
                        <dd class="vip-help-words">通常情况下充值过后金额就会在账户里显示出来的。但是电子帐单支付，需要等待3-6个交易日才能到帐。如果您对 交易有疑问的话可以提交给我们您的货品号和交易号，以便我们帮您核查。</dd>
                    </dl>
                    <!-- <dl class="w600 mb20">
                        <dt class="fb mb10">7、什么是自动续费服务？</dt>
                        <dd class="ml15">使用paypal升级会员时，可以开通会员自动续费服务。开通服务后，在您会员特权到期日前一天，系统将自动发起 扣费业务，每次扣费额度为您最近一次升级所花费用。并保证您当前会员特权自动从到期日延长相应时长。您也可 以进入您的paypal账户，进行关闭自动续费服务操作。</dd>
                    </dl> -->
                </div>
            </div>
        </div>
