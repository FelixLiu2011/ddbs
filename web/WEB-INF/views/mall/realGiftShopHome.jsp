...
<script type="text/javascript">
    ...
    var token="b82aec48866c4ca1b3a7189faeb5f941";
...
<div id="RedEnvelopeTCCon" style="display:none">
    <div>
        ...
        <div class="RedEnvelopeTCRight">
            ...
            <div class="clear"></div>
            <div class="moneyDiv cleard">Available gold:<!-- 账户可用金币 -->： <i class="money"></i><span class="moneyNum"> 0.00 </span><br/><a class="toRecharge" href="<%=path%>/pay/recharge">Go to recharge!<!-- 去充值 --></a></div>
...
<link href="<%=path%>/common/css/store.css" rel="stylesheet" type="text/css">
<link href="<%=path%>/common/css/animate.min.css" rel="stylesheet" type="text/css">
...
<div class="mid">
    <div class="w1100 jz">
        ...
        <div class="rgt fr">
            <!-- 广告 -->
            <div class="bcw h120 mall-ad">
                <a class="tc cur-pointer">
                    <img  alt="headAdv" src="<%=path%>/common/images/headAdv.png">
                </a>
            </div>

            <!-- 最近购买人 -->
            <div class="h430 bcw mt10 rgtct" >
                <a href="http://www.gagahi.com:80/mall/giftReal/goodlist" class="fr tle">My order</a>
                <div class="clear"></div>
                <div id="advertisementdiv">
                    <div class="w522 jz">
                        <ul class="buyersWrap">
                            <li class="h80 w80 fl ">
                                <img src="<%=path%>/common/images/portrait1.jpg">
                            </li>
                            <li class="h80 w80 fl ">
                                <img src="<%=path%>/common/images/portrait2.jpg">
                            </li>
                            <li class="h90  w90 fl">
                                <img src="<%=path%>/common/images/portrait3.jpg">
                            </li>
                            <li class="h80 w80 fl">
                                <img src="<%=path%>/common/images/photo3.jpg">
                            </li>
                            <li class="h80  w80 fl">
                                <img src="<%=path%>/common/images/user_img_3x3.jpg">
                            </li>
                            <div class="clear"></div>
                        </ul>
                    </div>
                    <div class="bcline mt30">
                        <p class="w190 jz title">They bought following things</p>
                    </div>
                    <div class="mtp35">
                        <ul>
                            <li class="lf inblok item">
                                <ul class="imageWrap">
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday1-1.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday1-2.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday1-3.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday1-4.png"></a></li>
                                    <div class="clear"></div>
                                </ul>
                                <p class="imgDes">Christmas</p>
                            </li>
                            <li class="lf inblok item">
                                <ul class="imageWrap">
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday2-1.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday2-2.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday2-3.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday2-4.png"></a></li>
                                    <div class="clear"></div>
                                </ul>
                                <p class="imgDes">Romantic Valentine's Day</p>
                            </li>
                            <li class="lf inblok item">
                                <ul class="imageWrap">
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday3-1.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday3-2.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday3-3.png"></a></li>
                                    <li class="fl"><a ><img alt="节日图片" src="<%=path%>/common/images/holiday3-4.png"></a></li>
                                    <div class="clear"></div>
                                </ul>
                                <p class="imgDes">Perfect encounter</p>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    </div>
            ...
            <!-- 商品展示 -->
            <div class="minh1000 bcw mt10 rgtbtm ">
                <ul class="linkItemWrap" id="itemWrap">



                    <li class="fl linkItem " gcid="88">
                        <a href="#">gift for mid-Autume</a>
                    </li>

                    <li class="fl linkItem " gcid="3">
                        <a href="#">GaGa Ya</a>
                    </li>

                    <li class="fl linkItem " gcid="11">
                        <a href="#">Valentine</a>
                    </li>

                    <li class="fl linkItem " gcid="7">
                        <a href="#">Gifts for Men</a>
                    </li>

                    <li class="fl linkItem " gcid="5">
                        <a href="#">Gifts for Women</a>
                    </li>

                    <li class="fl linkItem " gcid="75">
                        <a href="#">goddess season</a>
                    </li>
                ...
                <div class="clear"></div>
                <div id="linkPanels" class="mt30 linkPanels">
                    <div class="tab_panel">
                        <ul>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1666">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-9cf1636478944213bfe6f7e5499352ea">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>328</span><span class="fr lineTr f12">Original price328</span>
                                    <p class='mt10 tc f12'>Pink Striped Rabbit</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1665">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-09842be38974410c8e4335f6ce920f50">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>268</span><span class="fr lineTr f12">Original price268</span>
                                    <p class='mt10 tc f12'>Big Lovely Rabbit</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1615">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-04671752af504e6d86cad865f7001a43">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>169</span><span class="fr lineTr f12">Original price169</span>
                                    <p class='mt10 tc f12'>Many Blessings</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1613">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-0952d0fa9a684dce939e34fba399fa44">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>299</span><span class="fr lineTr f12">Original price299</span>
                                    <p class='mt10 tc f12'>Miss You</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1612">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-d20ebb200f734b4b957927fa0cf6f743">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>259</span><span class="fr lineTr f12">Original price259</span>
                                    <p class='mt10 tc f12'>Reunion</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1609">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-8f2a49282abe436fb68fe4481d547f64">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>399</span><span class="fr lineTr f12">Original price399</span>
                                    <p class='mt10 tc f12'>Love Moon Cake</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1608">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-1a697a4d68ad4b46baded3bbe335f382">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>499</span><span class="fr lineTr f12">Original price499</span>
                                    <p class='mt10 tc f12'>Romantic Affection</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1606">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-3af1d90528d14ff696022d2ee2edb9f5">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>358</span><span class="fr lineTr f12">Original price358</span>
                                    <p class='mt10 tc f12'>Blue Crystal Rabbit</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1605">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-3a7538e7a1664a2a83879d0808cc3bae">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>219</span><span class="fr lineTr f12">Original price219</span>
                                    <p class='mt10 tc f12'>Falling For You</p>
                                </a>
                            </li>

                            <li class="fl" >
                                <a href="http://www.gagahi.com:80/mall/giftReal/shopdetails?gireId=1603">
                           <span class="img-wrap">
                            <img src="http://images.gagahi.com//R-6ab51a24c960450e8a755785d3b2a0e7">
                            </span>
                                    <span class="money"></span><span class='cor-ff8a00 f14'>195</span><span class="fr lineTr f12">Original price195</span>
                                    <p class='mt10 tc f12'>Being Together</p>
                                </a>
                            </li>
                    ...
                    <div class="tab_panel" id="customTabPanel">
                        <ul>
                        </ul>
                    </div>
                </div>
...
<script src="<%=path%>/common/js/extension.js" type="text/javascript"></script>
<script src="<%=path%>/common/js/jquery.easing.min.js" type="text/javascript"></script>
<script src="<%=path%>/common/js/jquery.lavalamp.min.js" type="text/javascript"></script>
<script src="<%=path%>/common/js/jquery.page.js"></script>


<script>
    var qiniu = "http://images.gagahi.com/";
    var ctx="http://www.gagahi.com:80";
    ...
    $(function(){
        var Zoneyet= function () {
            this.initDom();
            this.bindEvent();
        }
        Zoneyet.prototype.initDom=function(){
            //初始化分类
            if(8>7){
                // 展示更多
                $("#itemWrap .linkItem.more").show();
            }
            var liobj = $("#itemWrap").find("li");
            if(null != liobj && liobj.length > 0){
                $("#itemWrap").lavalamp({
                    easing: 'easeOutBack',
                    enableHover:false,
                    //margins:true,
            ...
            $("#itemWrap").tabMenu({
                panel: $("#linkPanels"),
                beforeTrigger: function(idx, tab, panel, curIdx) {
                },
                initIndex:0,
                initTrigger: true,
                callback: function(idx, tab, panel, lastIdx) {
                    // 如果是第一次触发选项卡，或点击的是当前选项卡
//                if (typeof lastIdx === 'undefined' /*|| idx === lastIdx*/) {
//                    return;
//                }
                    if(idx != 6){
                        var gcid = $(tab).attr("gcid");
                        var ss=layer.load(0, {shade: 0.1});
                        $.ajax({
                            type : "post",
                            url : ctx + "/mall/giftReal/findgiftreal",
                            contentType : "application/x-www-form-urlencoded",
                            data: {"gcid":gcid},
                            success: function(data){
                                layer.close(ss);
                                if(data.success){
                                    ...
                                    $(panel).find("ul li").remove();
                                    var str = "";
                                    for(var i = 0;i < data.obj.length; i++){
                                        str += "<li class=\"fl\" >";
                                        str += "<a href=\""+ ctx + "/mall/giftReal/shopdetails?gireId=" + data.obj[i].gireId + "\"><span class='img-wrap'><img src=\""+ qiniu + data.obj[i].girePreview +"\"></span>";
                                        str += "<span class=\"money\"></span><span class='cor-ff8a00 f14'>"+ data.obj[i].discountGold +"</span>";
                                        str += "<span class=\"fr lineTr f12\">Original price"+ data.obj[i].gireGold +"</span>";
                                        str += "<p class='mt10 tc f12'>"+ data.obj[i].gireName +"</p></a></li>";
                                    }
                                    $(panel).find("ul").append(str+"<div class=\"clear\"></div>");
                                }else{
                                    layer.msg(data.msg);
                                }
                            }
        ...
        Zoneyet.prototype.bindEvent=function(){
            $("#itemWrap").on("click","li",function(){
                $("#itemWrap li").removeClass("active");
                $(this).addClass("active");
            });
            //更多分类中的内容切换
            $("#customItemWrap").on("click","li>a",function(){
//        	var typeId=$(this).attr("typeId");
//        	console.info(typeId);
//          $("#customTabPanel").html($("#customTabPanel").html());
                ...
                $.ajax({
                    ...
                    success: function(data){
                        layer.close(ss);
                        if(data.success){
                            $("#customTabPanel").find("ul li").remove();
                            for(var i = 0;i < data.obj.length; i++){
                                var str = "<li class=\"fl\" >";
                                str += "<a href=\""+ ctx + "/mall/giftReal/shopdetails?gireId=" + data.obj[i].gireId + "\"><span class='img-wrap'><img src=\""+ qiniu + data.obj[i].girePreview +"\"></span>";
                                str += "<span class=\"money\"></span><span class='cor-ff8a00 f14'>"+ data.obj[i].discountGold +"</span>";
                            ...
                            $("#customTabPanel").find("ul").append(str);
                        }else{
                            layer.msg(data.msg);
                        }
                    }
            ...
            //更多下拉
            $("#customItemWrap").mCustomScrollbar();
        }
        new Zoneyet();

        //商城顶部广告
        $._post('http://www.gagahi.com:80/ad/area/getContent', {
            areaCode: 1468467796580
        }, function(data) {
            if (data.success) {
                $('.mall-ad').html(data.obj);
            } else {
                $('.mall-ad').html('<a class="tc cur-pointer"><img  alt="headAdv" src="<%=path%>/common/images/headAdv.png"></a>');
            }
        }, function() {
            console.log('广告接口出错');
            $('.mall-ad').html('<a class="tc cur-pointer"><img  alt="headAdv" src="<%=path%>/common/images/headAdv.png"></a>');
        ...
        //节日
        function holidayShopList() {
            $('.rgtbtm').addClass('shoplist-holiday');
            if ($('body').attr('class') != 'zh-cn') {
                $('.rgtbtm').addClass('ho-en');
            }
        }
    ...
    $(document).ready(function(){
        /*  	$.ajax({//middle
         type : "post",
         url : ctx + "/ad/area/getContent",
         contentType : "application/x-www-form-urlencoded",
         data: {"areaCode":"002"},
         success: function(data){
         if(data.success){
         $("#advertisementdiv").append(data.obj);
         }else{
         layer.msg(data.msg);
         }
         }
