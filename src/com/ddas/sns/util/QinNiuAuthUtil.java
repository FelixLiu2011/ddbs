 ...
 */
public final class QinNiuAuthUtil {
    /**
     * 上传策略，参数规格详见
     * <p/>
    ...
    private QinNiuAuthUtil(String accessKey, SecretKeySpec secretKeySpec) {
        this.accessKey = accessKey;
        this.secretKey = secretKeySpec;
    }
    public static QinNiuAuthUtil create(String accessKey, String secretKey) {
        if (StringUtils.isNullOrEmpty(accessKey) || StringUtils.isNullOrEmpty(secretKey)) {
            throw new IllegalArgumentException("empty key");
        }
        byte[] sk = StringUtils.utf8Bytes(secretKey);
        SecretKeySpec secretKeySpec = new SecretKeySpec(sk, "HmacSHA1");
        return new QinNiuAuthUtil(accessKey, secretKeySpec);
    }
...
// TODO UpHosts Global
    ...
    public String uploadTokenWithPolicy(StringMap map) {
